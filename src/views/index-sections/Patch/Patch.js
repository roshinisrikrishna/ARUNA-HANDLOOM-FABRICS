...
Get inspired with our selection of patchwork fabrics! These unique textiles are made from a variety of different fabric scraps pieced together to create a visually interesting and one-of-a-kind look. Perfect for quilts, home décor, and other creative projects, patchwork fabrics offer endless possibilities for your next sewing or crafting adventure. Browse our collection today and let your imagination run wild with the endless design potential of patchwork fabrics  </p>
</Col>
...
<Container>
  <Row style={{justifyContent: 'space-between'}}>
    <Col xs={6} style={{marginTop:"5%",backgroundColor: "" , justifyContent:"flex-start", alignItems:"flex-start",textAlign:"left"}} >
      <Link to="/pintuck" className="previous-project-link" style={{fontSize:"20px", fontFamily:"Raleway, sans-serif", fontWeight:400, color:"black"}}>{" < "}Previous Project </Link>
    </Col>
    <Col xs={6} style={{marginTop:"5%",backgroundColor: "" , justifyContent:"flex-end", alignItems:"flex-end",textAlign:"right"}} >
      <Link to="/ikat" className="next-project-link" style={{fontSize:"20px", fontFamily:"Raleway, sans-serif", fontWeight:400, color:"black"}}>Next Project {" > "}</Link>
    </Col>
  </Row>
</Container>
