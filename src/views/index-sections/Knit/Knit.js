  ...
  return (
    <div className="main-approach" id="about-us" style={{maxWidth:"100%"}}>
      <Row style={{ marginTop:"-14%" }}>
        ...
        <Col className="sideheading-col d-flex align-items-center justify-content-center" lg={8} style={{ backgroundColor: "#FFF", padding: "32% 5% 4% 13%" }}>
...
<Col className="" lg={12} style={{height:"10%"}}>
  ...
  <Container className="mt-5"  style={{ backgroundColor: "" , justifyContent:"center", alignItems:"center",textAlign:"center"}}>
<Col className="" lg={12} style={{height:"10%"}}>
